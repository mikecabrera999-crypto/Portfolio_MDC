      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        <figure
          ...
          className="flex flex-wrap justify-center gap-4 relative order-2 lg:order-1">
           ...
           {/*  Image */}
            <div className="absolute -inset-10 lg:-inset-20 bg-linear-to-1 from-[#f97316] via-[#fb923c] to-[#f59e0b] rotate-12 star-shape z-0"
                data-aos='zoom-in'
                data-aos-delay='600'>
              </div>
            <img
        ...
        <article
          ...
          className='text-center lg:text-left relative order-1 lg:order-2'>
            ...
            <p
                ...
                data-aos='fade-up'
                data-aos-delay='500'>
                  "I have plan to be a Front-end Developer"
