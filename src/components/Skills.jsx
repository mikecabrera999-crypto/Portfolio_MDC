...
const Skills = ({ darkMode }) => {
    ...
    const skills = [
        {name: 'React', icon: react, level: 50,
            color: 'from-cyan-500 to-blue-500' },
        {name: 'Vite', icon: vite, level: 60,
            color: 'from-blue-500 to-purple-500' },
        {name: 'Java Script', icon: js, level: 65,
            color: 'from-orange-500 to-amber-500' }, 
        {name: 'Tailwind CSS', icon: tailwind, level: 55,
  ...
  return ( 
    ...
    className='py-14 relative overflow-hidden'>
        <div className='py-14 relative overflow-hidden'>
            <div className='container px-5 py-14 max-auto'>
                                    ...
                                    borderColor: darkMode ? '#374151' : '#e5e7eb'
                                          ...
                                          hover:shadow-[0_0_30px_rgb(255, 165,0,0,0.15)]'>
                                            ...
                                            items-center'>
                                                ...
                                                <span
                                                style={{
                                                    background: 'linear-gradient(to right, #f97316, #f99e0b)',
                                                    WebkitBackgroundClip: 'text',
                                                    backgroundClip: 'text',
                                                    color: 'transparent'
                                                }}
                                                ...
                                                style={{
                                                    backgroundColor: darkMode ? '#34151':'#e5e7eb'
                                                }}>
                                                    <div
